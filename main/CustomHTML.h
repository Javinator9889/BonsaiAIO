...
"<div>"
    ...
    "<p>"
        "<form action=\"/io\" method=\"get\">"
            ...
            "<p><input type=\"number\" placeholder=\"Elapsed time...\" value=\"{WLVL_TIME}\" step=\"1\" min=\"1\" name=\"wlvl\"></p>"
            "<label>Temperature & humidity sensor</label><br />"
            "<p><input type=\"number\" placeholder=\"Elapsed time...\" value=\"{TEMP_HUMD_TIME}\" step=\"1\" min=\"1\" name=\"dht\"></p>"
            "<h2>Other options</h2>"
